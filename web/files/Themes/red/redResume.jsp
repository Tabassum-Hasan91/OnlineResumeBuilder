<%-- 
    Document   : blueResume
    Created on : 26 Jul, 2019, 7:45:38 PM
      ...
      <div id="paper-mid">
        <div class="entry">
          ...
          <div class="self">
              ...
              <h1 class="name">${sessionScope.fname} ${sessionScope.lname}<br />
                  <span>${sessionScope.designation}</span></h1>
            <ul>
                <li class="ad">${sessionScope.address}</li>
                <li class="mail">${sessionScope.email}</li>
                <li class="tel">${sessionScope.phone}</li>
        ...
        <div class="entry">
          <h2>EDUCATION</h2>
          <div class="content">
              <h3>${sessionScope.degClgYear}</h3>
              <p>${sessionScope.degClgName} <br />
              <p>${sessionScope.degClgUniversity}, ${sessionScope.degClgCity} <br />
                  <em>${sessionScope.degClgCourse}</em></p>
          </div>
          <div class="content">
              
              <h3>${sessionScope.jrClgYear}</h3>
              <p>${sessionScope.jrClgName} <br />
              <p>${sessionScope.jrClgCity} <br />
                  <em>${sessionScope.jrClgCourse}</em></p>
          </div>
        </div>
        <!-- End 2nd Row -->
        <!-- Begin 3rd Row -->
